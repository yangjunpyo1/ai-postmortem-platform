...
import { formatKSTDateTime, formatKSTDate } from '../utils/date';
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-lg p-6">
              ...
              <dl className="space-y-3 text-sm">
                <div>
                  ...
                  <dd className="text-gray-100">{formatKSTDateTime(incident.started_at)}</dd>
                </div>
                <div>
                  <dt className="text-gray-400">종료 시각</dt>
                  <dd className="text-gray-100">{incident.ended_at ? formatKSTDateTime(incident.ended_at) : '-'}</dd>
                </div>
                <div>
              ...
              <div className="space-y-3">
                {similar.map(inc => (
                  ...
                  >
                    ...
                    <p className="text-xs text-gray-400 mt-1">{inc.severity} · {inc.category} · {formatKSTDate(inc.started_at)}</p>
                  </div>
                ))}
              </div>
            </div>
